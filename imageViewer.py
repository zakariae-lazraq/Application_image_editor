...
class ImageViewer(Frame):
    ...
    def __init__(self, master=None):
        Frame.__init__(self, master=master, bg="white", width=600, height=400)
        ...
        self.rectangle_id = 0
        self.ratio = 0
        self.canvas = Canvas(self, bg="#B0C4DE",width=800, height=600,)
    ...
    def draw(self, event):
        self.draw_ids.append(self.canvas.create_line(self.x, self.y, event.x, event.y, width=2,
                                                     fill="blue", capstyle=ROUND, smooth=True))
